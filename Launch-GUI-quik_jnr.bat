...
if defined pwshVersion (
    ...
    pwsh.exe -NoProfile -ExecutionPolicy Bypass -File "%scriptDir%Main-GUI.ps1" -StartupMode quik_jnr !TASKTRAY_ARG! !SUPPRESS_FOOTER_ARG!
    goto end
)
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%scriptDir%Main-GUI.ps1" -StartupMode quik_jnr !TASKTRAY_ARG! !SUPPRESS_FOOTER_ARG!

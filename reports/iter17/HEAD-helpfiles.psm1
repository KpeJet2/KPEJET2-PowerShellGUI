    ...
    try {
        ...
        foreach ($culture in $UICultures) {
            ...
            try {
                ...
                Write-Verbose "├ó┼ôΓÇ£ Saved help for $culture"
            } catch {
                Write-AppLog "Error saving help for culture $($culture): $_" "Warning"
                Write-Verbose "├ó┼ôΓÇö Error saving help for $culture : $_"
            }
        }
    ...
    try {
        ...
        foreach ($culture in $UICultures) {
            ...
            try {
                ...
                Write-Verbose "├ó┼ôΓÇ£ Updated help for $culture"
            } catch {
                Write-AppLog "Error updating help for culture $($culture): $_" "Warning"
                Write-Verbose "├ó┼ôΓÇö Error updating help for $culture : $_"
            }
        }

...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>Pygame Tutorials - Sprite Module Introduction &#8212; pygame v2.6.1 documentation</title>
...
<h2>Sprite Module Introduction<a class="headerlink" href="#sprite-module-introduction" title="Link to this heading">¶</a></h2>
...
<h3>History Lesson<a class="headerlink" href="#history-lesson" title="Link to this heading">¶</a></h3>
...
<h3>The Classes<a class="headerlink" href="#the-classes" title="Link to this heading">¶</a></h3>
...
<h3>The Sprite Class<a class="headerlink" href="#the-sprite-class" title="Link to this heading">¶</a></h3>
...
<p>When using your Sprite classes it's best to think of them as &quot;valid&quot; or
...
<h3>The Group Class<a class="headerlink" href="#the-group-class" title="Link to this heading">¶</a></h3>
...
<h3>Mixing Them Together<a class="headerlink" href="#mixing-them-together" title="Link to this heading">¶</a></h3>
...
<h3>The Many Group Types<a class="headerlink" href="#the-many-group-types" title="Link to this heading">¶</a></h3>
...
<h3>The Rendering Groups<a class="headerlink" href="#the-rendering-groups" title="Link to this heading">¶</a></h3>
...
<h3>Collision Detection<a class="headerlink" href="#collision-detection" title="Link to this heading">¶</a></h3>
...
<blockquote>
<div><p><a class="reference internal" href="../ref/sprite.html#pygame.sprite.spritecollide" title="pygame.sprite.spritecollide"><code class="xref py py-func docutils literal notranslate"><span class="pre">spritecollide(sprite,</span> <span class="pre">group,</span> <span class="pre">dokill,</span> <span class="pre">collided</span> <span class="pre">=</span> <span class="pre">None)</span> <span class="pre">-&gt;</span> <span class="pre">list</span></code></a></p>
<blockquote>
...
<h3>Extending Your Own Classes <em>(Advanced)</em><a class="headerlink" href="#extending-your-own-classes-advanced" title="Link to this heading">¶</a></h3>

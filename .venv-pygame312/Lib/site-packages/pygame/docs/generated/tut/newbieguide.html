...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>A Newbie Guide to pygame &#8212; pygame v2.6.1 documentation</title>
...
<h2>A Newbie Guide to pygame<a class="headerlink" href="#a-newbie-guide-to-pygame" title="Link to this heading">¶</a></h2>
...
<h3>Get comfortable working in Python.<a class="headerlink" href="#get-comfortable-working-in-python" title="Link to this heading">¶</a></h3>
...
<h3>Recognize which parts of pygame you really need.<a class="headerlink" href="#recognize-which-parts-of-pygame-you-really-need" title="Link to this heading">¶</a></h3>
...
<h3>Know what a surface is.<a class="headerlink" href="#know-what-a-surface-is" title="Link to this heading">¶</a></h3>
...
<h3>Use Surface.convert().<a class="headerlink" href="#use-surface-convert" title="Link to this heading">¶</a></h3>
...
<h3>Be wary of outdated, obsolete, and optional advice.<a class="headerlink" href="#be-wary-of-outdated-obsolete-and-optional-advice" title="Link to this heading">¶</a></h3>
...
<h3>There is NO rule six.<a class="headerlink" href="#there-is-no-rule-six" title="Link to this heading">¶</a></h3>
</section>
<section id="don-t-get-distracted-by-side-issues">
<h3>Don't get distracted by side issues.<a class="headerlink" href="#don-t-get-distracted-by-side-issues" title="Link to this heading">¶</a></h3>
...
<h3>Rects are your friends.<a class="headerlink" href="#rects-are-your-friends" title="Link to this heading">¶</a></h3>
...
<h3>Don't bother with pixel-perfect collision detection.<a class="headerlink" href="#don-t-bother-with-pixel-perfect-collision-detection" title="Link to this heading">¶</a></h3>
...
<h3>Managing the event subsystem.<a class="headerlink" href="#managing-the-event-subsystem" title="Link to this heading">¶</a></h3>
...
<h3>Software architecture, design patterns, and games.<a class="headerlink" href="#software-architecture-design-patterns-and-games" title="Link to this heading">¶</a></h3>
...
<h3>Do things the pythony way.<a class="headerlink" href="#do-things-the-pythony-way" title="Link to this heading">¶</a></h3>

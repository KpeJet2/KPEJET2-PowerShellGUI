...
$btnCapture.Add_Click({
    ...
    try {
        ...
        $viewStatusLbl.Text = "Capture failed: $_"
        [System.Windows.Forms.MessageBox]::Show("Capture failed:`n$_",'Capture Error',[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Error) | Out-Null
    } finally {

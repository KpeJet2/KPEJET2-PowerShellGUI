...
function Populate-ViewTree {
    ...
    if ($snap.Data.ISEConfiguration) {
        Add-Node $isen "Snippets ($(@($snap.Data.ISEConfiguration.SnippetFiles).Count))" 'ise_snip' | Out-Null
        Add-Node $isen "Registry Settings ($(@($snap.Data.ISEConfiguration.RegistrySettings).Count))" 'ise_reg' | Out-Null
    }
    ...
    if ($snap.Data.TerminalConfiguration) {
        Add-Node $termn "Console Host Settings ($(@($snap.Data.TerminalConfiguration.ConhostSettings).Count))" 'terminal_con' | Out-Null
    }

...
$tabs.Add_DrawItem({
    ...
    $e.Graphics.DrawString($tab.Text, $fontBold, [System.Drawing.Brushes]::White, $rect, $tf)
    $brush.Dispose()
})
...
$viewStatusLbl.Size      = New-Object System.Drawing.Size(440, 20)
...
$btnCapture.Add_Click({
    ...
    Invoke-WithProgress $viewProgress $viewStatusLbl {
        param($cb)
        $script:LiveSnapshot = Get-ProfileSnapshot -ProfileName "$($env:USERNAME)-live" -ProgressCallback $cb
    }
    Populate-ViewTree
    $viewStatusLbl.Text = "Snapshot captured at $(Get-Date -Format 'HH:mm:ss')"
    $statusLabel.Text   = "Live snapshot ready — $($script:LiveSnapshot.Data.WingetApplications.Count) apps, $($script:LiveSnapshot.Data.PSEnvironment.InstalledModules.Count) modules"
...
$savePanel.Size      = New-Object System.Drawing.Size(640, 540)
...
$saveInfoLbl.Location  = New-Object System.Drawing.Point(16, 320)
...
$saveProgress.Location = New-Object System.Drawing.Point(16, 362)
...
$savePrgLbl.Location  = New-Object System.Drawing.Point(16, 382)
...
$btnSaveProfile = New-StyledButton 'Capture & Save Profile' 16 410 200 34
    ...
    try {
        Invoke-WithProgress $saveProgress $savePrgLbl {
            ...
            if ($null -eq $script:LiveSnapshot) {
                $script:LiveSnapshot = Get-ProfileSnapshot -ProfileName $profileName -ProgressCallback $cb
            } else {
        ...
        [System.Windows.Forms.MessageBox]::Show("Save failed:`n$_",'Error',[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Error) | Out-Null
    } finally {
...
$cmpTopPanel.Size      = New-Object System.Drawing.Size(1090, 60)
...
$cmpProfileLbl.Location  = New-Object System.Drawing.Point(10, 20)
...
$cmpCombo.Location      = New-Object System.Drawing.Point(104, 16)
$cmpCombo.Size          = New-Object System.Drawing.Size(500, 24)
...
$btnCmpRefresh = New-StyledButton 'Refresh List' 614 14 110 28 ([System.Drawing.Color]::FromArgb(60,60,60))
$cmpTopPanel.Controls.Add($btnCmpRefresh)

$btnCmpLoad = New-StyledButton 'Compare' 734 14 110 28
$cmpTopPanel.Controls.Add($btnCmpLoad)

$cmpStatusLbl = New-Object System.Windows.Forms.Label
$cmpStatusLbl.Location  = New-Object System.Drawing.Point(855, 18)
...
$legendPanel.Location  = New-Object System.Drawing.Point(8, 72)
...
$cmpCatTabs.Location  = New-Object System.Drawing.Point(8, 102)
$cmpCatTabs.Size      = New-Object System.Drawing.Size(1090, 620)
...
function Load-ProfileList {
    ...
    foreach ($p in $profiles) {
        $display = "$($p.ProfileName) | $($p.CapturedOn.Substring(0,10)) | $(if ($p.Encrypted) { '[ENC]' } else { '' }) $($p.FileName)"
        $cmpCombo.Items.Add($display) | Out-Null
...
$btnCmpLoad.Add_Click({
    ...
    try {
        # Clear grids
        foreach ($g in @($cmpGridWinget,$cmpGridModules,$cmpGridDrivers,$cmpGridMime,$cmpGridTaskbar,$cmpGridConfigs,$cmpGridPS)) {
            $g.Rows.Clear()
        }
        ...
        $total = ($diff.WingetApps.Added.Count + $diff.WingetApps.Removed.Count + $diff.WingetApps.Changed.Count +
                  $diff.PSModules.Added.Count + $diff.PSModules.Removed.Count + $diff.PSModules.Changed.Count)
        $cmpStatusLbl.Text = "Done — $total change(s) detected"
        $statusLabel.Text  = "Compare complete: $($profileMeta.ProfileName) vs live"
    } catch {
        [System.Windows.Forms.MessageBox]::Show("Compare failed:`n$_",'Error',[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Error) | Out-Null
        $cmpStatusLbl.Text = "Failed: $_"
    } finally {
...
$restTopPanel.Size      = New-Object System.Drawing.Size(1090, 60)
...
$restProfileLbl.Location  = New-Object System.Drawing.Point(10, 20)
...
$restCombo.Location      = New-Object System.Drawing.Point(108, 16)
$restCombo.Size          = New-Object System.Drawing.Size(500, 24)
...
$btnRestRefresh = New-StyledButton 'Refresh List' 618 14 110 28 ([System.Drawing.Color]::FromArgb(60,60,60))
$restTopPanel.Controls.Add($btnRestRefresh)

$btnLoadRest = New-StyledButton 'Load Profile' 738 14 120 28 ([System.Drawing.Color]::FromArgb(50,90,50))
$restTopPanel.Controls.Add($btnLoadRest)

$restLoadLbl = New-Object System.Windows.Forms.Label
$restLoadLbl.Location  = New-Object System.Drawing.Point(868, 18)
...
$restOptPanel.Location  = New-Object System.Drawing.Point(8, 76)
...
$rollbackNotice.Location  = New-Object System.Drawing.Point(8, 304)
...
$btnStartRestore = New-StyledButton 'Start Restore' 8 362 180 36 ([System.Drawing.Color]::FromArgb(160,40,40))
...
$restProgress.Location = New-Object System.Drawing.Point(200, 368)
...
$restStatusLbl.Location  = New-Object System.Drawing.Point(8, 406)
...
$restLog.Location   = New-Object System.Drawing.Point(8, 434)
$restLog.Size       = New-Object System.Drawing.Size(1080, 280)
...
function Load-RestoreList {
    ...
    $profiles = Get-ProfileList -ProfileStorePath $script:ProfileStorePath
    foreach ($p in $profiles) {
        $display = "$($p.ProfileName) | $($p.CapturedOn.Substring(0,10)) | $(if ($p.Encrypted) { '[ENC]' } else { '' })$(if ($p.IsRollback) { '[ROLLBACK]' } else { '' }) $($p.FileName)"
        $restCombo.Items.Add($display) | Out-Null
    }
...
$btnLoadRest.Add_Click({
    ...
    try {
        ...
        if ($_ -match 'ENCRYPTED:') {
            ...
            [System.Windows.Forms.MessageBox]::Show("Load failed:`n$_",'Error',[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Error) | Out-Null
        }
    }
})
...
$btnStartRestore.Add_Click({
    ...
    try {
        ...
        [System.Windows.Forms.MessageBox]::Show("Restore encountered an error:`n$_",'Error',[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Error) | Out-Null
    } finally {
        $btnStartRestore.Enabled = $true
    }
})

...
function Invoke-Phase1-Inventory {
    <#
...
function Invoke-Phase2-ReadmeCheck {
    <#
...
function Invoke-Phase3-VersionBump {
    <#
...
function Invoke-Phase4-ManifestAlign {
    <#
...
function Invoke-Phase5-DependencyCalc {
    <#
...
function Invoke-Phase6-AgentHandback {
    <#
...
function Invoke-Phase7-Summarize {
    <#
...
function Invoke-Phase8-MemoryWrite {
    <#
...
"@
    ...
    for ($i = $startIdx; $i -lt @($phases).Count; $i++) {
        ...
        switch ($phaseName) {
            'Inventory' {
                $inventoryResult = Invoke-Phase1-Inventory -WorkspacePath $WorkspacePath -HoursBack $HoursBack
            }
            'ReadmeCheck' {
                if ($null -eq $inventoryResult) {
                    $inventoryResult = Invoke-Phase1-Inventory -WorkspacePath $WorkspacePath -HoursBack $HoursBack
                }
                Invoke-Phase2-ReadmeCheck -WorkspacePath $WorkspacePath -InventoryResult $inventoryResult -DryRun:$DryRun
            }
            'VersionBump' {
                Invoke-Phase3-VersionBump -WorkspacePath $WorkspacePath -DryRun:$DryRun
            }
            'ManifestAlign' {
                if ($SkipManifest) {
                    ...
                    Invoke-Phase4-ManifestAlign -WorkspacePath $WorkspacePath -DryRun:$DryRun
                }
            }
            'DependencyCalc' {
                if ($SkipDependency) {
                    ...
                    Invoke-Phase5-DependencyCalc -WorkspacePath $WorkspacePath -DryRun:$DryRun
                }
            }
            'AgentHandback' {
                $hasHandbacks = Invoke-Phase6-AgentHandback -WorkspacePath $WorkspacePath
                if ($hasHandbacks) {
                    Write-RELog '  Handbacks pending -- continuing to summarization' 'Warning'
                }
            }
            'Summarize' {
                Invoke-Phase7-Summarize -WorkspacePath $WorkspacePath
            }
            'MemoryWrite' {
                Invoke-Phase8-MemoryWrite -WorkspacePath $WorkspacePath
            }
        }
    }
...
Export-ModuleMember -Function @(
    'Invoke-REmemorAiZ',
    'Invoke-Phase1-Inventory',
    'Invoke-Phase2-ReadmeCheck',
    'Invoke-Phase3-VersionBump',
    'Invoke-Phase4-ManifestAlign',
    'Invoke-Phase5-DependencyCalc',
    'Invoke-Phase6-AgentHandback',
    'Invoke-Phase7-Summarize',
    'Invoke-Phase8-MemoryWrite'
)

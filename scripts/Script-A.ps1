...
Write-Information "Script-AAA: AAA EXAMPLE SCRIPT" -InformationAction Continue
Write-Information "================================" -InformationAction Continue
Write-Information "" -InformationAction Continue
...
Write-Information "  [OK] TASK 1 - AAA EXAMPLE SCRIPT" -InformationAction Continue

Write-Information "  [OK] TASK 2 - AAA EXAMPLE SCRIPT" -InformationAction Continue

Write-Information "  [OK] TASK 3 - AAA EXAMPLE SCRIPT" -InformationAction Continue

Write-Information "  [OK] TASK 4 - AAA EXAMPLE SCRIPT" -InformationAction Continue

Write-Information "  [OK] TASK 5 - AAA EXAMPLE SCRIPT" -InformationAction Continue
Write-Information "" -InformationAction Continue
...
Write-Information "AAA completed." -InformationAction Continue
Wait-KeyOrTimeout -Seconds 5
Write-Information "Script-A execution finished." -InformationAction Continue

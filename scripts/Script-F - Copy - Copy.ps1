...
Write-Information "Script-FFF: FFF EXAMPLE SCRIPT" -InformationAction Continue
Write-Information "================================" -InformationAction Continue
Write-Information "" -InformationAction Continue
...
Write-Information "  [OK] TASK 1 - FFF EXAMPLE SCRIPT" -InformationAction Continue

Write-Information "  [OK] TASK 2 - FFF EXAMPLE SCRIPT" -InformationAction Continue

Write-Information "  [OK] TASK 3 - FFF EXAMPLE SCRIPT" -InformationAction Continue

Write-Information "  [OK] TASK 4 - FFF EXAMPLE SCRIPT" -InformationAction Continue

Write-Information "  [OK] TASK 5 - FFF EXAMPLE SCRIPT" -InformationAction Continue
Write-Information "" -InformationAction Continue

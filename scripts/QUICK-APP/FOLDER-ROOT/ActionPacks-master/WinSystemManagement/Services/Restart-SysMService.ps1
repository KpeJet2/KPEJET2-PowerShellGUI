...
.Parameter ServiceName
    [sr-en] Name of service to be restarted

.Parameter ServiceDisplayName
    [sr-en] Display name of service to be restarted
#>
...
try{
    ...
    $null = Restart-Service -InputObject $Script:srv -Confirm:$false -Force -ErrorAction Stop

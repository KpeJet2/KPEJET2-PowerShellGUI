...
.Parameter ServiceName
    [sr-en] Name of service to be resumed

.Parameter ServiceDisplayName
    [sr-en] Display name of service to be resumed
#>
...
try{
    ...
    $null = Resume-Service -InputObject $Script:srv -Confirm:$false -ErrorAction Stop

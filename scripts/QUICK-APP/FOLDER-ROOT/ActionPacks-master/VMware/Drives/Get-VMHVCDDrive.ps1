...
<#
    ...
    .Parameter VMName
        [sr-en] Virtual machine from which you want to retrieve virtual CD drives
        [sr-de] Virtuelle Maschine
        
    .Parameter TemplateName
        [sr-en] Virtual machine template from which you want to retrieve virtual CD drives
        [sr-de] Vorlage

    .Parameter SnapshotName
        [sr-en] Snapshot from which you want to retrieve virtual CD drives
        [sr-de] Snapshot-Name

    .Parameter DriveName
        [sr-en] Name of the CD drive you want to retrieve, is the parameter empty all cd drives retrieved
        [sr-de] CD-Laufwerk
#>
...
try{
    ...
    $Script:Output = Get-CDDrive @cmdArgs -Name $DriveName | Select-Object *

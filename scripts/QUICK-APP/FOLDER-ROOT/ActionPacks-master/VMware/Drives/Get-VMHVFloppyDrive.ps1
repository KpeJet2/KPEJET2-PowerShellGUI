...
<#
    ...
    .Parameter DriveName
        [sr-en] Name of the floppy drive you want to retrieve, is the parameter empty all floppy drives retrieved
        [sr-de] Laufwerksname
#>
...
try{
    ...
    $Script:Output = Get-FloppyDrive @cmdArgs -Name $DriveName | Select-Object *

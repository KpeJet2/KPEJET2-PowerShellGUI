...
<#
    .SYNOPSIS
        Retrieves the IDs of the available datastores
...
try{
    ...
    $stores = Get-Datastore -Server $Script:vmServer -Refresh:$RefreshFirst -ErrorAction Stop | Select-Object Id,Name | Sort-Object Name

...
<#
    ...
    .Parameter HostName
        [sr-en] Host for which you want to retrieve firewall exceptions
        [sr-de] Hostname

    .Parameter PortNumber
        [sr-en] Number of the port for which you want to retrieve the firewall exceptions
        [sr-de] Portnummer 

    .Parameter Enabled
        [sr-en] Retrieve only the enabled hosts firewall exceptions
        [sr-de] Firewall-Ausnahmen der aktivierten Hosts 
#>

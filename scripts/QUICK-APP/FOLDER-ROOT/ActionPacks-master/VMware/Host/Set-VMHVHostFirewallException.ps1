...
<#
    ...
    .Parameter HostName
        [sr-en] Host for which you want to retrieve the firewall exception
        [sr-de] Hostname

    .Parameter ExceptionName
        [sr-en] Name of the firewall exception you want to modify
        [sr-de] Name der Firewall Exception

    .Parameter Enabled
        [sr-en] If the value is $true, the specified firewall exceptions are enabled
        [sr-de] Firewall-Exceptions aktivieren
#>

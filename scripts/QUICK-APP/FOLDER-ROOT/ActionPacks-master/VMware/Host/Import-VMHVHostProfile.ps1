...
<#
    ...
    .Parameter FilePath
        [sr-en] Path to the file, from which you want to import a host profile
        [sr-de] Importdatei

    .Parameter ProfileName
        [sr-en] Name of the imported host profile
        [sr-de] Name des Profiles

    .Parameter Description
        [sr-en] Description for the imported host profile
        [sr-de] Beschreibung des Profiles
#>

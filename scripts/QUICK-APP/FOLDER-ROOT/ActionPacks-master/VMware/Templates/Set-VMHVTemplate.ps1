...
<#
    ...
    .Parameter NewName
        [sr-en] New name for the template
        [sr-de] Neuer Name der Vorlage
#>
...
try{
    ...
    $result = Set-Template -Template $Script:temp -Name $NewName -Server $Script:vmServer -Confirm:$false -ErrorAction Stop

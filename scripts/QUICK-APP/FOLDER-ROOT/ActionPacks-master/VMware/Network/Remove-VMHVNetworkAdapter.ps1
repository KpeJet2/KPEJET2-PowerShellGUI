...
<#
    ...
    .Parameter VMName
        [sr-en] Virtual machine from which you want to remove the virtual network adapter
        [sr-de] Name der VM des Netzwerk-Adapters

    .Parameter AdapterName
        [sr-en] Name of the virtual network adapter you want to remove

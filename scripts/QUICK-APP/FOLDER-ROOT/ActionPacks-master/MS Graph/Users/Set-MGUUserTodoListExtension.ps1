...
try{
    ...
    $null = Update-MgUserTodoListExtension @cmdArgs
    $result = Get-MgUserTodoListExtension -UserId $UserId -ExtensionId $ExtensionId -TodoTaskListId $TodoListId | Select-Object *

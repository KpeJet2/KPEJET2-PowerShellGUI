...
try{
    ...
    if($PSBoundParameters.ContainsKey('CategoryId') -eq $true){
        $cmdArgs.Add('DeviceCategoryId',$CategoryId)
    }
    else{
        $cmdArgs.Add('All',$null)
    }
    $result = Get-MgDeviceManagementDeviceCategory @cmdArgs | Select-Object *

...
try{
    ...
    if($PSBoundParameters.ContainsKey('PolicyId') -eq $true){
        $cmdArgs.Add('DeviceCompliancePolicyId',$PolicyId)
    }
    else{
        $cmdArgs.Add('All',$null)
    }
    $result = Get-MgDeviceManagementDeviceCompliancePolicy @cmdArgs | Select-Object *

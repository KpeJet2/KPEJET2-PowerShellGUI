...
try{
    [hashtable]$cmdArgs = @{ErrorAction = 'Stop'
                'DeviceCompliancePolicySettingStateSummaryId' = $SettingStateSummaryId
    }
    $result = Get-MgDeviceManagementDeviceCompliancePolicySettingStateSummaryDeviceComplianceSettingState @cmdArgs | Select-Object *

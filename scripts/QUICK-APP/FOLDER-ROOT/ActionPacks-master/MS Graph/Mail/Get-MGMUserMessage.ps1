...
param( 
    ...
    [string]$UserId,
    [string]$MessageId,
    [ValidateSet('Subject','Id','BodyPreview','ChangeKey','ConversationId','ConversationIndex','CreatedDateTime',
    ...
    [string[]]$Properties = @('Subject','Id','BodyPreview','ReceivedDateTime','SentDateTime')
)
...
try{
    ...
    $result = Get-MgUserMessage @cmdArgs | Sort-Object -Descending ReceivedDateTime | Select-Object $Properties

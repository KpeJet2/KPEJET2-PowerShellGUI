...
<#
    .SYNOPSIS
        Updates a user mail folder message
...
try{
    ...
    $null = Update-MgUserMailFolderMessage @cmdArgs
    $result = Get-MgUserMailFolderMessage -MessageId $MessageId -UserId $UserId -MailFolderId $MailFolderId | Select-Object $Properties
    if($SRXEnv) {

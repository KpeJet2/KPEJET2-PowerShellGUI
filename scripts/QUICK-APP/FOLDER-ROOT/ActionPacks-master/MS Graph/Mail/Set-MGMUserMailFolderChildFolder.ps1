...
<#
    .SYNOPSIS
        Updates a child folder in the mail folder
    ...
    .Parameter DisplayName
        [sr-en] Child folder display name
        [sr-de] Ordnername
#>
...
try{
    ...
    $result = Update-MgUserMailFolderChildFolder @cmdArgs

    $result = Get-MgUserMailFolderChildFolder -MailFolderId1 $ChildFolderId -UserId $UserId -MailFolderId $MailFolderId | Select-Object $Properties
    if($SRXEnv) {

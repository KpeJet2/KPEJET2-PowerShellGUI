...
try{
    ...
    switch($ResultType){
        'AsAdministrativeUnit'{
            $result = Get-MgGroupTransitiveMemberOfCountAsAdministrativeUnit @cmdArgs
        }
        'AsGroup'{
            $result = Get-MgGroupTransitiveMemberOfCountAsGroup @cmdArgs
        }
        default{
            $result = Get-MgGroupTransitiveMemberOfCount @cmdArgs
        }
    }

...
<#
    ...
    .NOTES
        ...
        The customer or user is authorized to copy the script from the re# VersionTag: 2602.a.11
# SupportPS5.1: null
# SupportsPS7.6: null
# SupportPS5.1TestedDate: null
# SupportsPS7.6TestedDate: null
...
try{ 
    ...
    $result = Get-BrokerAppAssignmentPolicyRule @cmdArgs | Select-Object $Properties

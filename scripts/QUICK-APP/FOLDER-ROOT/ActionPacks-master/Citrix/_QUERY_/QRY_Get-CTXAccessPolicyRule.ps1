...
<#
    ...
    .NOTES
        ...
        The customer or user is authorized to copy the script from the repository and use them in Script# VersionTag: 2602.a.11
# SupportPS5.1: null
# SupportsPS7.6: null
# SupportPS5.1TestedDate: null
# SupportsPS7.6TestedDate: null
...
try{ 
    ...
    $result = Get-BrokerAccessPolicyRule @cmdArgs | Select-Object $Properties

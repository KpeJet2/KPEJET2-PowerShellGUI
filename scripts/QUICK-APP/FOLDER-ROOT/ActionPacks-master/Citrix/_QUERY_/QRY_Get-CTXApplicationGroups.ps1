...
<#
    ...
    .NOTES
        ...
        The customer or user is authorized to copy the script from the repository and use them in ScriptRu# VersionTag: 2602.a.11
# SupportPS5.1: null
# SupportsPS7.6: null
# SupportPS5.1TestedDate: null
# SupportsPS7.6TestedDate: null
...
<#
    ...
    .Parameter TenantId	
        ...
        [sr-de] Anwendungs-Gruppen, des angegebenen Mandanten
#>
...
try{ 
    ...
    $result = Get-BrokerApplicationGroup @cmdArgs | Select-Object Name,Uid | Sort-Object Name

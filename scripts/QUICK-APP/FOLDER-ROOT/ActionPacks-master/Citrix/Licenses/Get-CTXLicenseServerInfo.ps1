...
try{ 
    ...
    $address = $null
    GetLicenseLocation -ServerName $LicenseServer -Address ([ref]$address) -AddressType $AddressType -ServerPort $LicenseServerPort
    $ret = Get-LicServerInfo -AdminAddress $address -ErrorAction Stop | Select-Object *

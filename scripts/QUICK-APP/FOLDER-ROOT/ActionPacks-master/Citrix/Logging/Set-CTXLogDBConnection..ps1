...
<#
    ...
    .Parameter ConnectionString
        [sr-en] Database connection string to be used by the ConfigurationLogging Service
        [sr-de] Datenbankverbindungszeichenfolge
#>
...
try{ 
    ...
    StartLogging -ServerAddress $ControllerServer -LogText "Set Database connection" -LoggingID ([ref]$LogID)
    ...
    $ret = Set-LogDBConnection @cmdArgs | Select-Object *
    $success = $true

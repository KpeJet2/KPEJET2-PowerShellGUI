...
<#
    ...
    .Parameter ConnectionString
        [sr-en] Database connection string to be tested by the currently selected Citrix ConfigurationLogging Service instance
...
try{ 
    ...
    StartLogging -ServerAddress $ControllerServer -LogText "Test Database connection" -LoggingID ([ref]$LogID)
    ...
    $tmp = Test-LogDBConnection @cmdArgs | Select-Object *

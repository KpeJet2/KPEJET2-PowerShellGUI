...
param(
    ...
    [Parameter(ParameterSetName = 'byId')]
    [Parameter(ParameterSetName = 'Default')]
    [ValidateSet('*','AllocationType','ApplicationsInUse','AssignedClientName','AssignedIPAddress','AssociatedUserNames','CatalogName',
                'DeliveryType','Description','DesktopGroupName','DesktopKind','FaultState','IPAddress','IsAssigned','IsPhysical','IsReserved',
                'LastConnectionFailure','MachineInternalState','MachineName','MaintenanceModeReason','OSType','OSVersion','PersistUserChanges',
                'PowerActionPending','PowerState','PublishedApplications','RegistrationState','SessionCount',
                'SessionState','SessionSupport','SessionType','SessionsEstablished','SessionsPending','SummaryState','Uid','ZoneName')]

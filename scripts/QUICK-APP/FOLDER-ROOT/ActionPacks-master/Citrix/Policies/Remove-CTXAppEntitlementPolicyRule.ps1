...
try{ 
    ...
    StartLogging -ServerAddress $SiteServer -LogText "Remove App Entitlement rule $($RuleName)" -LoggingID ([ref]$LogID)
    ...
    $ret = Remove-BrokerAppEntitlementPolicyRule @cmdArgs
    $success = $true
    if($SRXEnv) {

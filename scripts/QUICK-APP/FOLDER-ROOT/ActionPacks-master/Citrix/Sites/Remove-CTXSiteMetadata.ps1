...
<#
    ...
    .Parameter PropertyName	
        ...
        [sr-de] Name für die Eigenschaft die gelöscht wird
#>
...
try{ 
    ...
    StartLogging -ServerAddress $SiteServer -LogText "Remove site $($site.Name) metadata $($PropertyName)" -LoggingID ([ref]$LogID)
    ...
    $null = Remove-BrokerSiteMetadata @delArgs 

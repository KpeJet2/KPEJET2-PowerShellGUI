...
try{ 
    ...
    StartLogging -ServerAddress $SiteServer -LogText "Remove application group metadata $($PropertyName)" -LoggingID ([ref]$LogID)
    ...
    $null = Remove-BrokerApplicationGroupMetadata @delArgs
    $success = $true

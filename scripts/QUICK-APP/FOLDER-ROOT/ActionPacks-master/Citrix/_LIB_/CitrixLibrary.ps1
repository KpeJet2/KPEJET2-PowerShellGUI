...
[scriptblock]$Script:ImportFunctions = {
    Set-Item -Path Function:StartCitrixSession -Value $Using:function:StartCitrixSession
    Set-Item -Path Function:CloseCitrixSession -Value $Using:function:CloseCitrixSession
    Set-Item -Path Function:CheckCitrixServer -Value $Using:function:CheckCitrixServer
    Set-Item -Path Function:StartCitrixSessionAdv -Value $Using:function:StartCitrixSessionAdv
    Set-Item -Path Function:GetLicenseLocation -Value $Using:function:GetLicenseLocation
    Set-Item -Path Function:GetLicenseCertificate -Value $Using:function:GetLicenseCertificate
    Set-Item -Path Function:StartLogging -Value $Using:function:StartLogging
    Set-Item -Path Function:StopLogging -Value $Using:function:StopLogging
}

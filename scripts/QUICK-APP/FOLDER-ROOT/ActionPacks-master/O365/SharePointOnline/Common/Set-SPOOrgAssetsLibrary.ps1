...
<#
    ...
    .Parameter LibraryUrl
        [sr-en] Indicates the server relative URL of the library to be modified

    .Parameter ThumbnailUrl
        [sr-en] Indicates the URL of the background image used when the library is publicly displayed
#>

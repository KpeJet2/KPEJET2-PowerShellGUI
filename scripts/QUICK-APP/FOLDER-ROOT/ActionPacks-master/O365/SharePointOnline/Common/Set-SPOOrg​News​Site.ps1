...
<#
    ...
    .Parameter OrgNewsSiteUrl
        [sr-en] The URL of a site to be marked as an organizational news site
#>
...
try{    
    $result = Set-SPOOrgNewsSite -OrgNewsSiteUrl $OrgNewsSiteUrl -ErrorAction Stop | Select-Object *

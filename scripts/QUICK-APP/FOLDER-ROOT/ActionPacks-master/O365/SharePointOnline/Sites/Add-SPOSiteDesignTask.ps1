...
<#
    ...
    .Parameter SiteDesignId
        [sr-en] The ID of the site design to apply

    .Parameter WebUrl
        [sr-en] The URL of the site collection where the site design will be applied
#>
...
try{    
    ...
    $result = Add-SPOSiteDesignTask @cmdArgs | Select-Object *

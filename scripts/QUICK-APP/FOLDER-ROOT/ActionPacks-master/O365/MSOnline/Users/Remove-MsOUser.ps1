...
<#
    ...
    .Parameter UserObjectId
        [sr-en] Unique object ID of the user to remove

    .Parameter UserName
        [sr-en] Display name, Sign-In Name or user principal name of the user to remove

    .Parameter RemoveFromRecycleBin
        [sr-en] Removes user from the Azure Active Directory recycle bin

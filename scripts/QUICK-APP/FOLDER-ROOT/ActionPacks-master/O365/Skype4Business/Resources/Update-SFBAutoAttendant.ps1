...
<#
    ...
    .Parameter Identity
        [sr-en] The identity for the AA whose resources are to be updated
...
try{
    ...
    $null = Update-CsAutoAttendant @cmdArgs
    $result = Get-CsAutoAttendant -Identity $Identity -ErrorAction Stop

...
try{
    [string[]]$Properties = @('Identity','Description','AllowChannelMeetingScheduling','AllowMeetNow','AllowPrivateMeetNow','AllowIPAudio','AllowIPVideo')
    ConnectS4B -S4BCredential $SFBCredential

    [hashtable]$cmdArgs = @{'ErrorAction' = 'Stop'}   
      
    $result = Get-CsTeamsMeetingConfiguration @cmdArgs | Select-Object $Properties

...
<#
    ...
    .Parameter Identity
        [sr-en] Specify the unique name of a policy you would like to retrieve
        [sr-de] Gibt den eindeutigen Namen der Policy an
#>
...
try{
    [string[]]$Properties = @('Identity','Description','AllowOrgWideTeamCreation','AllowPrivateTeamDiscovery','AllowPrivateChannelCreation')
    ...
    $result = Get-CsTeamsChannelsPolicy @cmdArgs | Select-Object $Properties

...
<#
    ...
    .Parameter LocalStore
        [sr-en] Retrieves the dial plan information from the local replica
        [sr-de] Informationen von der lokalen Replikation
...
try{
    [string[]]$Properties = @('SimpleName','Identity','Description','DataSource','ScopeClass','CountryCode')
    ...
    $result = Get-CsDialPlan @cmdArgs | Sort-Object SimpleName | Select-Object $Properties

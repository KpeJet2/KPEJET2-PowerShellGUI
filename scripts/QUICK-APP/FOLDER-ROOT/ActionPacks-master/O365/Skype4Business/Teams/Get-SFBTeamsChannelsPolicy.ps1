...
<#
    .SYNOPSIS
        Returns policies that are available for use within your organization
    ...
    .Parameter Identity 
        [sr-en] Unique name of a policy you would like to retrieve
#>
...
try{
    ...
    $result = Get-CsTeamsChannelsPolicy @cmdArgs | Select-Object *

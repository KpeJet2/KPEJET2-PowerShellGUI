...
<#
    ...
    .Parameter Identity
        [sr-en] Unique Identity of the OAuth configuration settings

    .Parameter LocalStore
        [sr-en] Retrieves the OAuth configuration data from the local replica of the Central Management store rather than from the Central Management store itself
...
try{
    ...
    $result = Get-CsOAuthConfiguration @cmdArgs | Select-Object *

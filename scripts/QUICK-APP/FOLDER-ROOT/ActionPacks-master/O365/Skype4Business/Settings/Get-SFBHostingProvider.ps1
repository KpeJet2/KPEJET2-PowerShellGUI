...
<#
    ...
    .Parameter Identity
        [sr-en] Unique identifier for the hosting provider to be returned

    .Parameter LocalStore
        [sr-en] Retrieves the hosting provider data from the local replica of the Central Management store rather than from the Central Management store itself
#>

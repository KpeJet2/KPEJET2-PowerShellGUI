...
<#
    ...
    .Parameter Identity
        [sr-en] A unique identifier for the rule

    .Parameter LocalStore
        [sr-en] Retrieves the voice normalization rule from the local replica of the Central Management store, rather than the Central Management store itself
...
try{
    ...
    $result = Get-CsVoiceNormalizationRule @cmdArgs | Select-Object *

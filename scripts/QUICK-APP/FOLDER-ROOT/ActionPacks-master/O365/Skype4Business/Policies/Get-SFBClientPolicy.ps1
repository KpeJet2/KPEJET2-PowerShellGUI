...
<#
    ...
    .Parameter Identity
        [sr-en] Unique identifier of the client policy to be returned

    .Parameter LocalStore
        [sr-en] Retrieves the client policy data from the local replica of the Central Management store rather than from the Central Management store itself
...
try{
    ...
    $result = Get-CsClientPolicy @cmdArgs | Select-Object *

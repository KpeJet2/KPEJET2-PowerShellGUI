...
<#
    ...
    .Parameter Identity
        [sr-en] Unique identifier of the mobility policy to be returned

    .Parameter LocalStore
        [sr-en] Retrieves the mobility policy data from the local replica of the Central Management store rather than from the Central Management store itself
...
try{
    ...
    $result = Get-CsMobilityPolicy @cmdArgs | Select-Object *

...
<#
    ...
    .Parameter Identity
        [sr-en] Identity for the application instance whose association provisioning status is to be retrieved
...
try{
    ...
    $result = Get-CsOnlineApplicationInstanceAssociationStatus @cmdArgs | Select-Object *

...
<#
    ...
    .Parameter LocalStore
        [sr-en] Retrieves the configuration from the local replica of the Central Management store rather than from the Central Management store itself
#>
...
try{
    ...
    $result = Get-CsOnlineDialinConferencingTenantConfiguration @cmdArgs | Select-Object *

...
.Parameter PrinterName
    [sr-en] Printer name on which to suspend the print job

.Parameter JobID
    [sr-en] ID of the print job to suspend on the specified printer

.Parameter ComputerName
    [sr-en] Name of the computer on which to suspend a print job

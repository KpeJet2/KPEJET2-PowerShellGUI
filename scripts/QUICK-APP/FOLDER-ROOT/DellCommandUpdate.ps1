...
function Install-DellCommandUpdate {
  ...
  if ($CurrentVersion.DisplayVersion -lt $LatestDellCommandUpdate.Version) {
    ...
    if ($PSCmdlet.ShouldProcess('Dell Command Update', 'Install/Upgrade')) {
...
function Install-DotNetDesktopRuntime {
  ...
  if ($CurrentVersion -lt $LatestDotNet.Version) {
    ...
    if ($PSCmdlet.ShouldProcess('.NET Desktop Runtime', 'Install')) {
...
function Invoke-DellCommandUpdate {
  ...
  try {
    ...
    if ($PSCmdlet.ShouldProcess('Dell Command Update', 'Configure')) {
    ...
    # Install updates
    if ($PSCmdlet.ShouldProcess('Dell Command Update', 'Apply Updates')) {
...
if ($Reboot) {
  ...
  if ($PSCmdlet.ShouldProcess('System', 'Reboot in 60 seconds')) {

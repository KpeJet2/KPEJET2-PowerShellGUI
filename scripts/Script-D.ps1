...
Write-Information "Script-DDD: DDD EXAMPLE SCRIPT" -InformationAction Continue
Write-Information "================================" -InformationAction Continue
Write-Information "" -InformationAction Continue
...
Write-Information "  [OK] TASK 1 - DDD EXAMPLE SCRIPT" -InformationAction Continue

Write-Information "  [OK] TASK 2 - DDD EXAMPLE SCRIPT" -InformationAction Continue

Write-Information "  [OK] TASK 3 - DDD EXAMPLE SCRIPT" -InformationAction Continue

Write-Information "  [OK] TASK 4 - DDD EXAMPLE SCRIPT" -InformationAction Continue

Write-Information "  [OK] TASK 5 - DDD EXAMPLE SCRIPT" -InformationAction Continue
Write-Information "" -InformationAction Continue
...
Write-Information "DDD completed." -InformationAction Continue
Wait-KeyOrTimeout -Seconds 5
Write-Information "Script-D execution finished." -InformationAction Continue
